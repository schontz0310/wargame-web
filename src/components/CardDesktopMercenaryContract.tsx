          ...
          <div className="bg-transparent rounded-lg h-full p-4">
            <div className="w-full h-full rounded-lg overflow-hidden relative">
              ...
              {selectedCard.cardModel === 'single' ? (
                ...
                (() => {
                  const factionParts = selectedCard.faction.split('-').map(p => p.trim());
                  const topFaction = factionParts[0] || selectedCard.faction;
                  const bottomFaction = factionParts[1] || selectedCard.faction;
                  return (
              ...
              {/* Left Red Box */}
              <div className="absolute pointer-events-none z-20 bg-transparent overflow-hidden" style={{
                top: '15%', left: '7%', width: '37%', height: '70%'
              }}>
                {selectedCard.contractText && (
                  <p className="font-ocr p-2 m-0" style={{fontSize: '22px', fontWeight: 900, color: '#000', letterSpacing: '0.01em', lineHeight: '1.3', textShadow: '0.05px 0.05px 0.05px black'}}>
                    {selectedCard.contractText}
                  </p>
                )}
              </div>
